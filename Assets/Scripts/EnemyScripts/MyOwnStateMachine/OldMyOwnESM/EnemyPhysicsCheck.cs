...
public class EnemyPhysicsCheck : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawLine(ground_checkpoint.position + new Vector3(ground_check_X, 0), ground_checkpoint.position + new Vector3(ground_check_X, -ground_check_Y_length));
        Gizmos.DrawLine(ground_checkpoint.position + new Vector3(-ground_check_X, 0), ground_checkpoint.position + new Vector3(-ground_check_X, -ground_check_Y_length));
        Gizmos.DrawLine(ground_checkpoint.position, ground_checkpoint.position + new Vector3(0, -ground_check_Y_length));
